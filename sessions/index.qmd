...
3. Formulate coherent quantitative argument.
...
- This module doesn't teach programming, so CASA0013 is strongly recommended if you don't know any Python.

## Course Structure
- Lectures: Tuesdays 9:00–10:30; G03 Bedford Way (26). 
- Tutorials: Wednesdays 10:30–12:00; G03 Bedford Way (26).
...
| ------- | ------------------------------ | -------- |
| 1       | Introduction to data           | Adam     |
| 2       | Probability and distribution   | Bea      |
| 3       | Hypothesis testing             | Bea      |
| 4       | Introduction to linear algebra | Bea      |
| 5       | Correlation and regression     | Adam     |
| 6       | Intro to Regression            | Adam     |
| 7       | Multiple Regression            | Adam     |
| 8       | Multilevel regression          | Adam     |
| 9       | Dimensionality reduction       | Bea      |
| 10      | Clustering Analysis            | Bea      |
...
## Github Feedback
You can also give feedback on [Github issues](https://github.com/Bea-Taylor/Quant_Methods/issues).