...
- What can be said about them?
  - :white_check_mark: equality, mode, median
  - :white_check_mark: addition, arithmetic mean
  - :x: ratio (*100°C is NOT twice 50°C*)

## Interval

- Another example: longtitude & latitude coordinates
- *The coordinate of 8 is twice as far as that of 4*? :x:
...
- What can be said about them?
  ...
  - :white_check_mark: Ratio (*2kg is twice as heavy as 1kg*)
...
- The middle: Mode 106433 (Useful? :x:)
...
- https://ft-interactive.github.io/visual-vocabulary/ ![](L1_images/FT_visual_vocabulary.jpg){style="max-width:90%; max-height:90%; margin:auto;"}
...
2.  In gender ratios of countries data, Vatican City with gender ratio of 7:1
3.  In UK city GDP data, GDP of Greater London
