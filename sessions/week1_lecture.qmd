...
## The everyday shorthand: numerical vs. categorical
...
Useful, but too coarse to tell you what to actually *do* with a variable.

# A finer-grained decomposition

## Why four levels are not enough

Stevens tells us what **operations** are permitted. It does not tell us which
**distribution** a variable follows, or which **model** to fit.

. . .

Consider two variables from our data, both on a **ratio** scale:

- the **number of pupils** at a school — whole numbers, cannot be negative
- the **percentage of sessions missed** through absence — continuous, strictly positive, heavily skewed

. . .

Same level of measurement. Completely different distributions, and completely
different models. We need something more specific.
...
- A count **bounded above** by the size of the cohort — it cannot exceed N
- The dashed line is the ceiling: every pupil disadvantaged
...
## Storing it wrong has consequences

::: {.incremental}
- Read Ofsted rating as plain text and R will order it **alphabetically** — Good, Inadequate, Outstanding, Requires improvement
