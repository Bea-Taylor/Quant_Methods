...
This is the classic starting point, and it is where most courses stop. We will
come back after it and sharpen it up.
...
- *In our data:* the **date of the last Ofsted inspection**. 2015 → 2018 is the
  same gap as 2018 → 2021, but "year zero" is a convention.
...
- Zero means "average expected progress"; positive is more, negative is less

. . .

The zero is **meaningful**, and the scale runs either side of it. So is it
ratio data?

. . .

**No.** A school scoring 1.0 has not made "twice the progress" of one scoring
0.5 — there is no true zero point of *no progress at all*. It is an
**interval** measure.

::: {.notes}
This is the slide that stops students assuming "has a zero" means "ratio".
We plot P8MEA later, in the finer taxonomy, where its symmetry is the point.
:::
