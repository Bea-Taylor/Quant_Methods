...
::: {.incremental}
- Same data, same axis. The dashed lines are the **quartiles**
- The **box** holds the middle 50% of schools; the line inside it is the **median**
- The whiskers reach the furthest point within 1.5 × the box width; anything beyond is drawn as an outlier
...
Flag anything with $|z| > 3$ — or 2, or 2.5, depending on who you ask.
:::
