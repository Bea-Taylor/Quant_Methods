...
# CARTO now require an API key on their raster tiles. With CARTO_KEY set
# in the environment the basemap comes through clean; without it we fall
# back to folium's built-in CartoDB tiles, which carry a watermark.
_carto_key = os.environ.get("CARTO_KEY", "")
if _carto_key:
    _tiles = ("https://basemaps.cartocdn.com/light_all/"
              "{z}/{x}/{y}{r}.png?key=" + _carto_key)
    _attr = ('&copy; <a href="https://www.openstreetmap.org/copyright">'
             'OpenStreetMap</a> contributors &copy; '
             '<a href="https://carto.com/attributions">CARTO</a>')
else:
    _tiles, _attr = "CartoDB.Positron", None
